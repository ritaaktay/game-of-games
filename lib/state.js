class State {
  ...
  update = function (time, keys) {
    ...
    //this intends to be a copy of the current state with updated actors
    let newState = new State(
      this.level,
      actors,
      this.status,
      this.miniGameStatus //when we move away it will remain as "playing" rather than resetting to null
    );
